...
import model.exceptions.ValidationExeception;
...
public class SellerFormController implements Initializable{
	...
	private Seller getFormData() {
		...
		ValidationExeception exception = new ValidationExeception("Validation erro");
	...
	private void setErrorMessages(Map<String,String> errors) {
		...
		labelErrorBirth.setText((fields.contains("birthDate") ? errors.get("birthDate"):""));
